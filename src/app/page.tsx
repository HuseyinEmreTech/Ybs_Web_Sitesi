          ...
          <ScrollReveal direction="up" delay={0.3}>
            <div className="mt-16 p-8 rounded-3xl glass-card">
              <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 divide-x divide-slate-200/50 dark:divide-slate-800/50">
                ...
                <div className="text-center px-4">
                  <p className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-br from-purple-600 to-pink-600 bg-clip-text text-transparent">{settings.stats.events}</p>
                  <p className="mt-2 text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Etkinlik</p>
                </div>
                <div className="text-center px-4">
                  <p className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-br from-pink-600 to-rose-600 bg-clip-text text-transparent">{settings.stats.projects}</p>
                ...
                <div className="text-center px-4 border-r-0">
                  <p className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-br from-rose-600 to-orange-600 bg-clip-text text-transparent">{settings.stats.yearsOfExperience}</p>
