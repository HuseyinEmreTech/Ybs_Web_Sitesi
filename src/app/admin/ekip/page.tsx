                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-400">
                                            Projenin <code className="bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">public/ekip</code> klasörüne attığınız resmin yolunu yazın.
                                            Örn: <code className="text-indigo-600 dark:text-indigo-400">/ekip/resim.jpg</code>
                                        </p>
                                    </div>

                                    {form.imageUrl && (
                                        <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-indigo-100 dark:border-indigo-900 mx-auto md:mx-0">
                                            ...
                                            <img
                                                ...
                                                onError={(e) => {
                                                    (e.target as HTMLImageElement).src = 'https://ui-avatars.com/api/?name=X&background=random'
                                                }}
                                            />
                                        </div>
                                    )}
