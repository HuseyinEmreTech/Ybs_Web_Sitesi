...
export default async function Footer() {
  ...
  return (
    <>
      <footer className="bg-slate-50 dark:bg-slate-950 border-gradient-t">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8">
              <details className="group/details">
                <summary className="list-none cursor-pointer sm:cursor-auto">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-semibold text-foreground mb-3">Sayfalar</h3>
                    <span className="sm:hidden text-slate-400 group-open/details:rotate-180 transition-transform">
